...
var normalModeSequenceRegex = regexp.MustCompile(`(?s)(?P<count>[1-9][0-9]*)?(?P<command>:|h|l|k|j|w|b|e|\{|\}|x|r.|^[1-9]?0|\^|\$|gg|G|i|I|a|A|o|O|d[dhjkl0$^]|D)$`)
...
func (m *normalMode) cursorNextWordEnd() exec.Mutator {
