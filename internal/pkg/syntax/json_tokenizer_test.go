...
func TestJsonTokenizer(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedTokens: []TokenWithText{
				{Text: `"key"`, Role: parser.TokenRoleString},
		...
		},
		{
			...
			expectedTokens: []TokenWithText{
				{Text: `"bool"`, Role: parser.TokenRoleString},
		...
		},
		{
			...
			expectedTokens: []TokenWithText{
				{Text: `"k1"`, Role: parser.TokenRoleString},
				{Text: `"v1"`, Role: parser.TokenRoleString},
				{Text: `"k2"`, Role: parser.TokenRoleString},
		...
		},
		{
			...
			expectedTokens: []TokenWithText{
				{Text: `"nested"`, Role: parser.TokenRoleString},
				{Text: `"k1"`, Role: parser.TokenRoleString},
				{Text: `123`, Role: parser.TokenRoleNumber},
				{Text: `"k2"`, Role: parser.TokenRoleString},
