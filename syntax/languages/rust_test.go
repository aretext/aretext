...
string";`,
		...
		},
		{
			...
			expected: []TokenWithText{
				...
				{Text: "invalidsuffix", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			...
			expected: []TokenWithText{
				{Text: "123", Role: parser.TokenRoleNumber},
				{Text: "AFB43", Role: parser.TokenRoleIdentifier},
			},
		},
		{
		...
		},
		{
			...
			expected: []TokenWithText{
				{Text: "0", Role: parser.TokenRoleNumber},
				{Text: "b_", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			...
			expected: []TokenWithText{
				{Text: "0", Role: parser.TokenRoleNumber},
				{Text: "x_", Role: parser.TokenRoleIdentifier},
			},
		},
		{
		...
		},
		{
			...
			text: "_foo",
			expected: []TokenWithText{
				{Text: "_foo", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			name: "raw identifier",
			text: "r#true",
			expected: []TokenWithText{
				{Text: "r#true", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			...
			text: "Москва",
			expected: []TokenWithText{
				{Text: "Москва", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			...
			text: "東京",
			expected: []TokenWithText{
				{Text: "東京", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			name: "lifetime label",
		...
		},
		{
			...
			text: "r#superbloom",
			expected: []TokenWithText{
				{Text: "r#superbloom", Role: parser.TokenRoleIdentifier},
			},
		},
		{
			...
			expected: []TokenWithText{
				...
				{Text: "print_refs", Role: parser.TokenRoleIdentifier},
				{Text: "<", Role: parser.TokenRoleOperator},
				...
				{Text: "&", Role: parser.TokenRoleOperator},
				{Text: "'a", Role: rustTokenRoleLifetime},
				{Text: "i32", Role: parser.TokenRoleIdentifier},
				{Text: "y", Role: parser.TokenRoleIdentifier},
				{Text: ":", Role: parser.TokenRoleOperator},
				{Text: "&", Role: parser.TokenRoleOperator},
				{Text: "'b", Role: rustTokenRoleLifetime},
    ...
    while n < 101 {
        ...
        n += 1;
			...
			expected: []TokenWithText{
				...
				{Role: parser.TokenRoleIdentifier, Text: "n"},
				...
				{Role: parser.TokenRoleIdentifier, Text: "println"},
				{Role: parser.TokenRoleOperator, Text: "!"},
